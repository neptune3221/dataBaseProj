...
CFLAGSCC=$(GFLAG) $(CDEBUG) $(CCFLAGSCC) $(QACCFLAGS) $(PFLAGS)\
	$(SHARED_CFLAG) $(USRFLAGS)
...
MR=-mr
NOKPIC_CCFLAGS= $(PROFILE) $(XS)  \
        -D_REENTRANT
NOKPIC_CCFLAGS64= $(PROFILE) $(XS)  \
        -xildoff -errtags=yes -v -xarch=v9 -D_REENTRANT \
        -DSS_64BIT_SERVER -DBIT64 -DMACHINE64 

CCFLAGS= $(NOKPIC_CCFLAGS) 
FASTCCFLAGS= $(NOKPIC_CCFLAGS)

NOKPIC_CCFLAGSCC= $(PROFILE) -noex $(XS) \
	-D_REENTRANT
...
CPLUS_CFLAGS=$(INCLUDE) -DSLTS_ENABLE -D_REENTRANT
